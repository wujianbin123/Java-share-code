...
public class RoomBean implements Serializable {
    ...
    public static class ResultBean implements Serializable{
        ...
        private ResultBean.OptionBean option;
        private ResultBean.RunningOptionBean running_option;
        ...
        public ResultBean.OptionBean getOption() {
            return option;
        }

        public void setOption(ResultBean.OptionBean option) {
            this.option = option;
        }

        public ResultBean.RunningOptionBean getRunning_option() {
            return running_option;
        }

        public void setRunning_option(ResultBean.RunningOptionBean running_option) {
        ...
        public static class OptionBean implements Serializable{
            ...
            private ResultBean.OptionBean.FilterBean filter;
            ...
            public ResultBean.OptionBean.FilterBean getFilter() {
                return filter;
            }

            public void setFilter(ResultBean.OptionBean.FilterBean filter) {
                this.filter = filter;
            }
        ...
        public static class RunningOptionBean implements Serializable{
            ...
            private int room_type;
            private int range;
            private ResultBean.RunningOptionBean.LmsrBean lmsr;
            ...
            private ResultBean.RunningOptionBean.LmsrRunningBean lmsr_running;
            private int guaranty_alone;
            private List<String> selection_description;
            private List<List<ResultBean.RunningOptionBean.ParticipatorsBean>> participators;
            private List<Integer> player_count;

            private ResultBean.RunningOptionBean.AdvancedRunningBean advanced_running;
            private ResultBean.RunningOptionBean.PVPRunningBean pvp_running;
            private ResultBean.RunningOptionBean.AdvancedBean advanced;

            public ResultBean.RunningOptionBean.AdvancedRunningBean getAdvanced_running() {
                return advanced_running;
            }

            public void setAdvanced_running(ResultBean.RunningOptionBean.AdvancedRunningBean advanced_running) {
                this.advanced_running = advanced_running;
            }

            public ResultBean.RunningOptionBean.PVPRunningBean getPvp_running() {
                return pvp_running;
            }

            public void setPvp_running(ResultBean.RunningOptionBean.PVPRunningBean pvp_running) {
                this.pvp_running = pvp_running;
            }

            public ResultBean.RunningOptionBean.AdvancedBean getAdvanced() {
                return advanced;
            }

            public void setAdvanced(ResultBean.RunningOptionBean.AdvancedBean advanced) {
            ...
            public ResultBean.RunningOptionBean.LmsrBean getLmsr() {
                return lmsr;
            }

            public void setLmsr(ResultBean.RunningOptionBean.LmsrBean lmsr) {
                this.lmsr = lmsr;
            }
            ...
            public ResultBean.RunningOptionBean.LmsrRunningBean getLmsr_running() {
                return lmsr_running;
            }

            public void setLmsr_running(ResultBean.RunningOptionBean.LmsrRunningBean lmsr_running) {
            ...
            public List<List<ResultBean.RunningOptionBean.ParticipatorsBean>> getParticipators() {
                return participators;
            }

            public void setParticipators(List<List<ResultBean.RunningOptionBean.ParticipatorsBean>> participators) {
