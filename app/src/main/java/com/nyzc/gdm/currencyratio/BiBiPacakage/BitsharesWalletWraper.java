...
//        file.delete();
    ...
    //1.2.16371  1.15.560
    public signed_transaction forecastTransfer(String issuer, int roomType, String roomId, String strAmount, int roomPosition) throws NetworkStatusException {

        signed_transaction signedTransaction = mWalletApi.forecast_transfer(issuer, roomType, roomId, strAmount, "SEER", roomPosition);
        return signedTransaction;
    }
