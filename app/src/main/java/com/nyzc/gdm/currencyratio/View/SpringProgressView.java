...
public class SpringProgressView extends View {
    ...
    /**分段颜色*/
    private static final int[] SECTION_COLORS = {MyApp.context.getResources().getColor(R.color.comment_titlebar),MyApp.context.getResources().getColor(R.color.near_blue)};
    /**进度条最大值*/
    ...
    protected void onDraw(Canvas canvas) {
      ...
      System.out.println("max="+maxCount + "  current="+currentCount);
        mPaint.setColor(getResources().getColor(R.color.progress_back));
