...
public class CustomTitleBar extends LinearLayout {
     ...
     * @param context
     */
    RelativeLayout rela_lefe_btn, rela_right_btn;
    ...
    public CustomTitleBar(Context context, @Nullable AttributeSet attrs) {
        ...
        rela_lefe_btn = findViewById(R.id.rela_lefe_btn);
        rela_right_btn = findViewById(R.id.rela_right_btn);
        /**获取属性值*/
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CustomTitleBar);
        /**标题相关*/
        title_background_color = typedArray.getColor(R.styleable.CustomTitleBar_title_background, getResources().getColor(R.color.white));
        title_text = typedArray.getString(R.styleable.CustomTitleBar_title_text);
        title_textColor = typedArray.getColor(R.styleable.CustomTitleBar_title_textColor, getResources().getColor(R.color.tab_tv_color));
        ...
        left_button_textColor = typedArray.getColor(R.styleable.CustomTitleBar_left_button_textColor, 0);
        left_button_textSize = typedArray.getColor(R.styleable.CustomTitleBar_left_button_textSize, 18);
        show_left_button = typedArray.getBoolean(R.styleable.CustomTitleBar_show_left_button, false);
        /**右边保存按钮相关*/
        ...
        right_button_textSize = typedArray.getColor(R.styleable.CustomTitleBar_right_button_textSize, 18);
        show_right_button = typedArray.getBoolean(R.styleable.CustomTitleBar_show_right_button, false);
        ...
        rela_lefe_btn.setOnClickListener(new OnClickListener() {
            @Override
        ...
        rela_right_btn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (titleOnClickListener != null) {
